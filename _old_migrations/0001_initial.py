# Generated by Django 5.0.6 on 2025-10-30 13:45

import apps_base._base.managers
import apps_base._base.model_fields
import apps_base._base.models
import apps_project.product_price.manager
import apps_project.product_price.models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('customer', '0022_alter_customerproduct_options_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_to', apps_base._base.model_fields.DateTimeField(default=apps_project.product_price.models.return_date_time_latest)),
                ('created_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('modified_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_modified_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            ...
            managers=[
                ('objects', apps_project.product_price.manager.DiscountCouponManager()),
            ],
        ),
        migrations.CreateModel(
            name='PriceGroup',
            fields=[
                ...
                ('created_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('modified_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_modified_by', to=settings.AUTH_USER_MODEL)),
                ('store', apps_base._base.model_fields.ForeignKey(default=entity.managers.StoreManager.get_current, on_delete=django.db.models.deletion.CASCADE, to='entity.store', verbose_name='Store')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            bases=(parler.models.TranslatableModelMixin, apps_base._base.models.ModelMixin, models.Model),
            managers=[
                ('objects', apps_project.product_price.manager.DiscountGroupManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', apps_base._base.model_fields.DateTimeField(auto_now_add=True)),
                ('modified_time', apps_base._base.model_fields.DateTimeField(auto_now=True)),
                ('pricing_type', apps_base._base.model_fields.CharField(choices=[('f', 'Fixed price'), ('u', 'Units'), ('sm', 'Subscription per month'), ('sy', 'Subscription per year'), ('h', 'Hourly'), ('pct', 'Percentage of Total')], max_length=3)),
                ...
                ('valid_to', apps_base._base.model_fields.DateTimeField(default=apps_project.product_price.models.return_date_time_latest, verbose_name='valid to')),
                ('created_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('modified_by', apps_base._base.model_fields.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_modified_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', apps_base._base.model_fields.DateTimeField(auto_now_add=True)),
                ('modified_time', apps_base._base.model_fields.DateTimeField(auto_now=True)),
                ('discount_abs', apps_base._base.model_fields.DecimalField(decimal_places=4, default=Decimal('0'), max_digits=10, verbose_name='discount absolute')),
        ...
        migrations.AddConstraint(
            model_name='discount',
            constraint=models.CheckConstraint(check=models.Q(('product__isnull', False), ('product_discount_group__isnull', False), _connector='OR'), name='new_product_or_group'),
        ),
